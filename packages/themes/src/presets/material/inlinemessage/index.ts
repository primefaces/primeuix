...
export const info: InlineMessageTokenSections.Info = {
    ...
    shadow: 'light-dark(0px 4px 8px 0px color-mix(in srgb, {blue.500}, transparent 96%), 0px 4px 8px 0px color-mix(in srgb, {blue.500}, transparent 96%))'
};
...
export const success: InlineMessageTokenSections.Success = {
    ...
    shadow: 'light-dark(0px 4px 8px 0px color-mix(in srgb, {green.500}, transparent 96%), 0px 4px 8px 0px color-mix(in srgb, {green.500}, transparent 96%))'
};
...
export const warn: InlineMessageTokenSections.Warn = {
    ...
    shadow: 'light-dark(0px 4px 8px 0px color-mix(in srgb, {yellow.500}, transparent 96%), 0px 4px 8px 0px color-mix(in srgb, {yellow.500}, transparent 96%))'
};
...
export const error: InlineMessageTokenSections.Error = {
    ...
    shadow: 'light-dark(0px 4px 8px 0px color-mix(in srgb, {red.500}, transparent 96%), 0px 4px 8px 0px color-mix(in srgb, {red.500}, transparent 96%))'
};
...
export const secondary: InlineMessageTokenSections.Secondary = {
    ...
    shadow: 'light-dark(0px 4px 8px 0px color-mix(in srgb, {surface.500}, transparent 96%), 0px 4px 8px 0px color-mix(in srgb, {surface.500}, transparent 96%))'
};
...
export const contrast: InlineMessageTokenSections.Contrast = {
    ...
    shadow: 'light-dark(0px 4px 8px 0px color-mix(in srgb, {surface.950}, transparent 96%), 0px 4px 8px 0px color-mix(in srgb, {surface.950}, transparent 96%))'
};
